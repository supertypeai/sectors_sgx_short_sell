...
def match_names(cleaned_unique_value_short_sell : list) -> list:
  ...
  for i in range (len(cleaned_unique_value_short_sell)):
    ...
    for company_data in companies_dict:
...
if __name__ == "__main__":
  ...
  list_of_dictionaries = match_names(cleaned_unique_value_short_sell)
